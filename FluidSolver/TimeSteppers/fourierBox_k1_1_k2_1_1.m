function [dX] =fourierBox_k1_1_k2_1_1(X,Pr,Ra,Ro)
...
-(2)*X(13)+(0.70711)*X(2)-(0.089794)*X(4)*X(16)-(-0.063494)*X(7)*X(14);
-(2)*X(14)+(-0.70711)*X(5)-(-0.089794)*X(1)*X(16)-(0.063494)*X(7)*X(13);
-(3)*X(15)+(-0.8165)*X(11);
-(3)*X(16)+(-0.8165)*X(12)-(0.089794)*X(1)*X(14)-(-0.089794)*X(4)*X(13);
-(1)*X(17)];
end